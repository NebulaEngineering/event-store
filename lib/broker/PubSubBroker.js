...
const { Subject, BehaviorSubject, Observable, defer } = require('rxjs');
            ...
            this.aggregateEventsMapConfiguredSubject$.pipe(
                ...
                (pubSubSubscription) => {
                    this.onMessage = message => {
                        ...
                        if (hasEventSourcingAttributes && (this.aggregateEventsMap[message.attributes.at] || {})[message.attributes.et] == null) {
                            message.ack();
                            return;
                        }
