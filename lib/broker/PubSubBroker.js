            ...
            this.intervalID = setInterval(
                (function(self) {         //Self-executing func which takes 'this' as self
                    return function() {   //Return a function in the context of 'self'
                        ConsoleLogger.d(`Unacked cronjob executed: ${self.unackedMessages ? self.unackedMessages.length: 'null'}`)                        
                    ...
                    this.onMessage = message => {
                        ...
                        if(!eventTypeConfig) {
                            ...
                            if((autoAck != null && autoAck)
                                ...
                                console.log('!this.unackedMessages[`${msgEvt.data.at}.${msgEvt.data.et}.${msgEvt.id}`] => ${msgEvt.data.at}.${msgEvt.data.et}.${msgEvt.id}', (!this.unackedMessages[`${msgEvt.data.at}.${msgEvt.data.et}.${msgEvt.id}`]));
                                ...
                                msgEvt.acknowledgeMsg = () => {
                                    ConsoleLogger.d(`unackedMessages: ${this.unackedMessages ? this.unackedMessages.length : null}`);                                                                                              
