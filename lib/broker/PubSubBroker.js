                    ...
                    return function() {   //Return a function in the context of 'self'
                        ...
                        if(self.unackedMessages) {
                            Object.keys(self.unackedMessages).forEach(key => {        
                                if(self.unackedMessages[key].timestamp <=  (Date.now()-(1*60*1000))){
                        ...
                        if(!eventTypeConfig) {
                            ...
                            if((autoAck != null && autoAck)
                                ...
                                msgEvt.acknowledgeMsg = () => {
                                    ConsoleLogger.d(`unackedMessages: ${self.unackedMessages ? Object.keys(self.unackedMessages).length : null}`);                                                                                              
