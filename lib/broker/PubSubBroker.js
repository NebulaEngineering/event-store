...
const EVENT_STORE_STATS_SLOW_ACK = parseInt(process.env.EVENT_STORE_STATS_SLOW_ACK || "5000", 10);
const EVENT_STORE_STATS_SLOW_PULL = parseInt(process.env.EVENT_STORE_STATS_SLOW_PULL || "5000", 10);
