    ...
    start$() {
        ...
        return Rx.Observable.create(observer => {
            ...
            setInterval(function() {
                ...
                ConsoleLogger.d(`Unacked cronjob executed: ${this.unackedMessages.length}`)
                this.unackedMessages.forEach(unackedMessage => {
                    ...
                    this.onMessage = message => {
                        ...
                        if(!eventTypeConfig) {
                            ...
                            if((autoAck != null && autoAck)
                                ...
                                ConsoleLogger.d(`ACK Before; aggregateType: ${aggregateType}, eventType: ${event.et}, autoAck: ${autoAck}, processOnlyOnSync: ${processOnlyOnSync}, messageAckAfterProcessed: ${messageAckAfterProcessed}`);
                                message.ack();                                
                            }else{
                                ...
                                msgEvt.acknowledgeMsg = () => {
                                    ...
                                    ConsoleLogger.d(`ACK After; aggregateType: ${aggregateType}, eventType: ${event.et}`);                                                          
                                    message.ack();
                                }
                            }
