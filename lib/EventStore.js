...
class EventStore {
    ...
    emitEvent$(event) {
        ...
        //     console.log("DistributionCenterAssigned ==> (init): ", Date.now());            
        // }        
        return this.storeDB.pushEvent$(event)
            .pipe(
                // tap(() => {                    
                //     if(event.et === "DistributionCenterAssigned"){
                //         console.log("DistributionCenterAssigned ==> (After pushEvent$): ", Date.now(), `(${Date.now() - initTime})`);            
                //     } 
                // }),
                concatMap((storeResult) =>
                    this.broker.publish$(storeResult.event)
                        .pipe(
                            // tap(() => {
                            //     if(event.et === "DistributionCenterAssigned"){
                            //         console.log("DistributionCenterAssigned ==> (After publish$): ", Date.now())            
                            //     }
