...
class EventStore {
     ...
     */
    retrieveEvents(aggregateType, aggregateId, aggregateVersion, {offset,pageSize}) { 
        console.log('EVT ====> retrieveEvents');
     ...
     */
    retrieveNewAggregates(aggregateType, timestamp, {offset,pageSize}) {
        console.log('EVT ====> retrieveNewAggregates');
        return this.storeDB.findAgregatesCreatedAfter$(aggregateType, timestamp, {offset,pageSize})
        .map(aggregate => {
